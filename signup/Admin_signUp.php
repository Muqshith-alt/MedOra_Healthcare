...
<html lang="en">
  ...
  <body>
    <div class="container">
      <h1>MedOra</h1>
      <img class="image" src="Admin_login_bg.jpg" alt="Hospital" />
    </div>
    ...
    <div class="signup">
      ...
      <div class="right">
        ...
        <p class="login">
          ...
          <a href="../login/admin_login.php">Already Have Account?</a>
        </p>
        ...
        <form id="myform" action="../backend/signUp_logic.php" method="POST">
          ...
          <div class="group">
            <input name="mob" class="edit" type="tel" id="mob" placeholder="Enter Your Contact Number" required />
