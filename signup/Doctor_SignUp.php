...
<body>
  ...
  <div class="signup">
    ...
    <div class="right">
      ...
      <p class="login">
        <a href="../login/doctor_login.php">Already Have Account?</a>
      </p>`

      <form id="myform" action="../backend/doctor_signUp_logic.php" method="POST">
        <div class="group">
        ...
        <div class="group">
          <input name="mob" class="edit" type="text" id="mob" placeholder="Enter Your Contact Number" required />
        ...
        <div class="group">
          <input class="edit"  name="specialization" type="text" id="specialization" placeholder="Search or enter specialization" onkeyup="showSuggestions(this.value)" required />
